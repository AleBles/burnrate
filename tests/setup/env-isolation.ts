...
const CLEARED = [
  ...
  'BURNRATE_CACHE_DIR',
  'BURNRATE_COPILOT_OTEL_DB',
  'BURNRATE_COPILOT_SESSION_STATE_DIR',
  'BURNRATE_COPILOT_WS_STORAGE_DIR',
  'BURNRATE_DESKTOP_SESSIONS_DIR',
  'BURNRATE_MUX_DIR',
  'BURNRATE_ANTIGRAVITY_SETTINGS_PATH',
  // codeburn behavior toggles (set by the dev to tweak local runs)
  'BURNRATE_COPILOT_DISABLE_OTEL',
  'BURNRATE_TZ',
  'BURNRATE_VERBOSE',
  'BURNRATE_CURSOR_MAX_BUBBLES',
  'BURNRATE_FORCE_MACOS_MAJOR',
